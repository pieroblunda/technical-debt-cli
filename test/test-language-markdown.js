...
// TODO: Test are testing entire Repository including readme.md and /test directory
const config = {
  // target: 'fixtures/**', // TODO
  extensions: ['md'],
...
describe('Language Markdown', () => {
  ...
  it('Should be return the exactly text', done => {
    assert.strictEqual(result[3], '3 Markdown This is a low priority task');
    done();
  });
